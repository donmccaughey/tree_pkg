...
Building was last tested on an Apple Silicon Mac with macOS Ventura 13.0 and
...
package is written into the project root with the name `tree-2.0.4.pkg`.
...
if notarization succeeds.  Use the command:
        ...
        $ xcrun stapler validate --verbose tree-2.0.4.pkg
